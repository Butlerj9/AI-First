...
function renderRechartsCharts() {
    ...
    // Development Speed Chart with Custom Tooltip
    const speedData = [
    ...
    const SpeedChart = React.createElement(ResponsiveContainer, { width: "100%", height: "100%" },
        React.createElement(BarChart, { data: speedData, margin: { top: 20, right: 30, left: 20, bottom: 5 } },
            React.createElement(CartesianGrid, { strokeDasharray: "3 3" }),
            React.createElement(XAxis, { dataKey: "name" }),
            React.createElement(YAxis, { label: { value: 'Speed Multiplier (×)', angle: -90, position: 'insideLeft' } }),
            React.createElement(Tooltip, { 
                content: CustomTooltip,
                valueFormatter: (value) => `${value}×`
            }),
            React.createElement(Bar, { dataKey: "speed", fill: "#3b82f6" })
        )
    );
...
function initComparisonTab() {
    ...
    if (typeof Recharts !== 'undefined') {
      ...
      // Productivity Chart - Fixed y-axis label position
      const ProductivityChart = React.createElement(ResponsiveContainer, { width: "100%", height: "100%" },
        React.createElement(BarChart, {
          ...
          React.createElement(CartesianGrid, { strokeDasharray: "3 3" }),
          React.createElement(XAxis, { dataKey: "metric" }),
      ...
      // Radar Chart - Keep it simple like the bar chart
      const RadarChartComponent = React.createElement(ResponsiveContainer, { width: "100%", height: "100%" },
        React.createElement(RadarChart, {
          ...
          React.createElement(Radar, { name: "AI-First", dataKey: "aiFirst", stroke: "#2196F3", fill: "#2196F3", fillOpacity: 0.6 }),
          React.createElement(Radar, { name: "AI-Assisted", dataKey: "aiAssisted", stroke: "#4CAF50", fill: "#4CAF50", fillOpacity: 0.6 }),
          React.createElement(Radar, { name: "Traditional", dataKey: "traditional", stroke: "#FF5252", fill: "#FF5252", fillOpacity: 0.6 }),
          React.createElement(Legend),
          React.createElement(Tooltip)
        )
      );
